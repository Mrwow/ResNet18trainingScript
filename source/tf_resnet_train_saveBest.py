...
def main(data_dir, out, gpu, nc, names, nps, bsz, resz):
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        print(
            "Overall accuracy is: {:.3f}, Each class accuracy: {}"
                .format(acc_test_epoch, each_class_acc))
        ...
        if acc_test_epoch > best_acc:
            ...
            if train_acc_epoch > 0.99:
                ...
                print(
                    'Epoch {} get better model; train accurayc is {}, testing accuracy is {}'
                        .format(epoch + 1, train_acc_epoch, acc_test_epoch))
...
if __name__ == '__main__':
    torch.manual_seed(0)
    # data_dir = "./data_09"
    main(args.data, args.out, args.gpu, args.nc, args.names, args.epoch, args.bsz, args.resz)
